...
export function EditItemDialog({ item, open, onOpenChange, onSuccess }: EditItemDialogProps) {
  ...
  useEffect(() => {
    if (item) {
      ...
      setDate(expiryDate)
      setValue("expiryDate", formatDateForInput(expiryDate))
    }
  }, [item, setValue])
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[500px] bg-white max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Update the details of your perishable item.</DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={watchedType} onValueChange={(value) => setValue("type", value as "grocery" | "medicine")}>
